 ...
 * 2015-09-01T19:45:26.169+10:00
 * Generated source version: 3.0.4
 * 
 */
@WebServiceClient(name = "MarketDataUtilServiceImplService", 
                  wsdlLocation = "http://localhost:8080/MarketDataUtilService/MarketDataUtilService?wsdl",
...
public class MarketDataUtilServiceImplService extends Service {
    ...
    public final static QName SERVICE = new QName("http://marketdatautilservice.soacourse.unsw.edu.au/", "MarketDataUtilServiceImplService");
    public final static QName MarketDataUtilServiceImplPort = new QName("http://marketdatautilservice.soacourse.unsw.edu.au/", "MarketDataUtilServiceImplPort");
    static {
        URL url = null;
        try {
            url = new URL("http://localhost:8080/MarketDataUtilService/MarketDataUtilService?wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(MarketDataUtilServiceImplService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "http://localhost:8080/MarketDataUtilService/MarketDataUtilService?wsdl");
        }
        WSDL_LOCATION = url;
    }
